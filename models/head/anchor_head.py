...
# Based on AnchorHeadSingle & AnchorHeadTemplate
import numpy as np
import torch
...
class AnchorHeadSingle(nn.Module):
    def __init__(self, cfg):
        # model_cfg, num_class, class_names, grid_size, point_cloud_range, predict_boxes_when_training
        super().__init__()
        self.cfg = cfg
        self.model_cfg = self.cfg.MODEL.HEAD
        roi = self.cfg.DATASET.roi
        x_min, y_min, z_min, x_max, y_max, z_max = roi.xyz
        point_cloud_range = roi.xyz

        # grid_size in OpenPCDet = [x_shape, y_shape, z_shape]
    ...
    def get_cls_layer_loss(self):
        ...
        # print(f'===========cls_targets: {box_cls_labels.shape}')
        ...
        # print(f'==========cls_loss, num_class: {self.num_class}')
        cls_preds = cls_preds.view(batch_size, -1, self.num_class)
        one_hot_targets = one_hot_targets[..., 1:]
        # print(f'==========cls_preds: {cls_preds.shape}, one_hot_targets: {one_hot_targets.shape}')
